...
public class AgenteCorreo extends Agent implements SendMessageListener {
	...
	public void setup()
	{
        ...
        //Añadimos un comportamiento cíclico para capturar y procesar los mensajes que recibe el agente
        //El comportamiento lo podríamos colocar es una clase independiente
        addBehaviour(new CyclicBehaviour(){
        	...
        	public void action() 
        	{
                ...
                try
        		{
                	//Si recibimos un mensaje en el que el contenido es null, querrá decir que hay nuevos agentes en el chat o agentes que han abandonado el chat
                	...
                	//Tendremos que recorrer todos aquellos chats que están activos para ir mostrando el mensaje
                	//Añadiremos el contenido del mensaje a continuación del contenido publicado previamente en el chat.
                	else
                	{
		...
		//una vez tenga el servicio ya registrado ya puedo avisar a todos los demás agentes del chat de que el agente ha entrado en el chat
		Utils.enviarMensaje(this, "mensajería", null);
	}
	...
	{
		// TODO Auto-generated method stub
		dfd=Utils.buscarAgentes(this, "mensajería");
	...
	@Override
	//Para envío de mensajes que no son del tipo "mensajería"
	...
	@Override
	// En este método controlamos los chats de tipo JPanelPrincipalMessenger en los que hay que mostrar mensajes
